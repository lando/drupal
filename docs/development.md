...
This guide contains information to help onboard developers to work on the [drupal](https://drupal.microsoft.com/en-us/) integration, hereafter referred to as *the plugin*.
