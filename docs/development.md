---
title: Development
description: Learn how to develop and contribute to the Lando Drupal service
---

# Development

This guide contains information to help onboard developers to work on the [Drupal](https://drupal.org) integration, hereafter referred to as "the plugin".
